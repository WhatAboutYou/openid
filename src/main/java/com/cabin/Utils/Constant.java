...
public class Constant {
    ...
    //用户同意授权，获取code
    public final  static String WX_GETCODE = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=APPID&redirect_uri=REDIRECT_URI&response_type=code&scope=SCOPE&state=STATE#wechat_redirect";
    //通过code获取access_token
    public final static String WX_GETACCESSTOKEN = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=APPID&secret=SECRET&code=CODE&grant_type=authorization_code";
    //获取用户个人信息（UnionID机制）
    public final static String WX_GETUSERINFO = "https://api.weixin.qq.com/sns/userinfo?access_token=ACCESS_TOKEN&openid=OPENID";
    ...
    //微信接入常量
    public final static String HYWX_APPID ="wx5941ad0e7058260b"; //APPID
    public final static String HYWX_APPSECRET = "bfecdeaad7b58937301d0c4adf85e460";//微信開發者密碼

    //微信接入常量
    public final static String SXWX_APPID ="wx330993a0fcae7c7d"; //APPID
    public final static String SXWX_APPSECRET = "28c4fd93dfd4c7b77bc02500ea1e41ae";//微信開發者密碼
