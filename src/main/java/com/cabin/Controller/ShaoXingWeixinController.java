 ...
 */
@RequestMapping(value = "/sxwx")
@RestController
public class ShaoXingWeixinController {
    public static Logger logger = Logger.getLogger(ShaoXingWeixinController.class);
    ...
    public synchronized void getWxOpenId(String url, HttpServletResponse response) throws Exception{
        ...
        String wxurl = Constant.WX_GETCODE.replace("APPID",Constant.SXWX_APPID)
                .replace("REDIRECT_URI", URLEncoder.encode("http://wscan.cabin-tech.com/sxwx/getWxCodeCallBack","utf-8"))
    ...
    public synchronized void getWxCodeCallBack(String code/*,String state*/,HttpServletResponse response) throws Exception{
        ...
        String url2 = Constant.WX_GETACCESSTOKEN.replace("APPID",Constant.SXWX_APPID).replace("SECRET",Constant.SXWX_APPSECRET).replace("CODE",code);
