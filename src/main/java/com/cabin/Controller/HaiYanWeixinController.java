 ...
 */
@RequestMapping(value = "/hywx")
@RestController
public class HaiYanWeixinController {
    public static Logger logger = Logger.getLogger(HaiYanWeixinController.class);
    ...
    public synchronized void getWxOpenId(String url, HttpServletResponse response) throws Exception{
        ...
        String wxurl = Constant.WX_GETCODE.replace("APPID",Constant.HYWX_APPID)
                .replace("REDIRECT_URI", URLEncoder.encode("http://wscan.cabin-tech.com/hywx/getWxCodeCallBack","utf-8"))
    ...
    public synchronized void getWxCodeCallBack(String code/*,String state*/,HttpServletResponse response) throws Exception{
        ...
        String url2 = Constant.WX_GETACCESSTOKEN.replace("APPID",Constant.HYWX_APPID).replace("SECRET",Constant.HYWX_APPSECRET).replace("CODE",code);
